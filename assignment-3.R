...
data0 <- read.csv("transactions-1.csv") ## Items
dim(data0)
head(data0)
## select the meaninful colunms for the analysis
data0 <- select(data2,fraud,sex,age,income1,same_city,same_count,seller_sco,dispersao,type)
...
valor <- kmeans(data3, 60, iter.max = 150, nstart = 10,algorithm = c("Hartigan-Wong",
                                                                      "Lloyd",
                                                                      "Forgy",
