...
## Loading the models
tb_model1 <- readRDS("/Curso-ML/Assignment-3/model1.rda")
tb_model2 <- readRDS("/Curso-ML/Assignment-3/model2.rda")
tb_model3 <- readRDS("/Curso-ML/Assignment-3/model3.rda")
tb_model4 <- readRDS("/Curso-ML/Assignment-3/model4.rda")
tb_model5 <- readRDS("/Curso-ML/Assignment-3/model5.rda")
##summary(train)
